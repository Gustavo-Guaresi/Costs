...
function Project(){
    ...
    useEffect(()=>{
        setTimeout(()=>{            //simular demora no processo para ver o carregamento, setTimeout é desnecessário
